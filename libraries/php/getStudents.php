...
echo '
    <div class="thumbnail student" data-first-name="'.$user->first_name.'" data-last-name="'.$user->last_name.'" title="'.$user->first_name.' '.$user->last_name.'">
        <a href="/students/view/options/id/' . $user->id . '">
            ...
            <img data-src="/images/student-image-thumbnails/' . str_replace(' ', '_', ucwords(strtolower($user->first_name))) . "_" . str_replace(' ', '_', ucwords(strtolower($user->last_name))) . '02.jpg" class="hover">
        </a>
